...
amount1 = input("Enter amount 1 (in cent): ")
amount2 = input("Enter amount 2 (in cent): ") 
...
roundanswer = round((answer / 100), 2)
...
print(f"The sum of these is €{roundanswer}") # using an f string to print the answer.
